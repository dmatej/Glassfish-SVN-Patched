 ...
 */
@XmlType
final public class StagingOperationRequest {
    ...
    public String getStagingProfileGroup() {
        return stagingProfileGroup;
    }

    public void setStagingProfileGroup(String stagingProfileGroup) {
        this.stagingProfileGroup = stagingProfileGroup;
    }

    public StagingOperationRequest(String[] ids, String stagingProfileGroup, String desc) {
        this.stagedRepositoryIds = ids;
        this.stagingProfileGroup = stagingProfileGroup;
