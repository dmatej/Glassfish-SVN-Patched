...
pkg = {
    "name"          : "glassfish-scripting-l10n",
    "version"       : conf.glassfish_version,
    "attributes"    : {
                        "pkg.summary" : "GlassFish Scripting Localization",
                        "pkg.description" : "Localization of GlassFish Scripting package."+conf.glassfish_description_long,
