...
CLASSPATH=$MVN_LOCAL_REPO/org/glassfish/hk2/core/2.1.28/core-2.1.28.jar:$MVN_LOCAL_REPO/org/glassfish/modularity-tools/modularity-tools.dependency-analyser/1.0.0-SNAPSHOT/modularity-tools.dependency-analyser-1.0.0-SNAPSHOT.jar:$MVN_LOCAL_REPO/org/glassfish/hk2/osgi-adapter/2.1.28/osgi-adapter-2.1.28.jar:$MVN_LOCAL_REPO/org/apache/bcel/bcel/5.2/bcel-5.2.jar:$MVN_LOCAL_REPO/org/osgi/org.osgi.core/4.3.0/org.osgi.core-4.3.0.jar:$MVN_LOCAL_REPO/org/glassfish/hk2/hk2-deprecated/2.1.28/hk2-deprecated-2.1.28.jar
