...
//list of all tables and views collected
    ...
    private LinkedList checkReferences(LinkedList tables, String schema) throws SQLException {
        ResultSet rs;
        String pkSchema;
        String fkSchema;
        String refTable;
    ...
    private void initViews(ConnectionProvider cp, LinkedList views) throws DBException, SQLException {
        String name;
        ResultSet rs;
...
//                                    schemas = ((rs.getString("FKTABLE_SCHEM") == rs.getString("PKTABLE_SCHEM")) || rs.getString("FKTABLE_SCHEM").equals(rs.getString("PKTABLE_SCHEM"))) ? true : false;
                    ...
                    initTables(cp, checkReferences(toCapture, cp.getSchema()), false);
