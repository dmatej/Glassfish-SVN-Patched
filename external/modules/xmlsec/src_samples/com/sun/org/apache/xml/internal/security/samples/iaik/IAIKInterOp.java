 ...
 *
 */
package com.sun.org.apache.xml.internal.security.samples.iaik;
...
public class IAIKInterOp {
   ...
   /** {@link java.util.logging} logging facility */
    static java.util.logging.Logger log = 
        java.util.logging.Logger.getLogger(IAIKInterOp.class.getName());
   ...
   public static void main(String unused[]) {
      ...
      for (int i = 0; i < 2; i++) {
         ...
         try {
            com.sun.org.apache.xml.internal.security.samples.signature
