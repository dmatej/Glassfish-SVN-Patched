...
import com.sun.org.apache.xml.internal.security.samples.utils.resolver.OfflineResolver;
...
public class CreateMerlinsExampleTwentyThree {
   ...
   /** {@link java.util.logging} logging facility */
    static java.util.logging.Logger log = 
        java.util.logging.Logger.getLogger(CreateMerlinsExampleTwentyThree.class.getName());
   ...
   public static void main(String unused[]) throws Exception {
      ...
      String keystoreFile = "data/com/sun/org/apache/xml/internal/security/samples/input/keystore.jks";
       ...
       */
      sig.getSignedInfo()
         .addResourceResolver(new com.sun.org.apache.xml.internal.security.samples.utils.resolver
            .OfflineResolver());
