...
public class TestSignature {
   ...
   public static void main(String unused[]) {
      ...
      String ourDir =
         "data/com/sun/org/apache/xml/internal/security/temp/key/";
      ...
      for (int file_to_verify = start; file_to_verify < end; file_to_verify++) {
         try {
            ...
            ki.addStorageResolver(new StorageResolver(new com.sun.org.apache.xml.internal.security.keys.storage.implementations.CertsInFilesystemDirectoryResolver(merlinsDir + "certs")));
