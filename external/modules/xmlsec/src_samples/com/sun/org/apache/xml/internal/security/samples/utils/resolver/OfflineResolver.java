 ...
 *
 */
package com.sun.org.apache.xml.internal.security.samples.utils.resolver;
...
public class OfflineResolver extends ResourceResolverSpi {
   ...
   /** {@link java.util.logging} logging facility */
    static java.util.logging.Logger log = 
        java.util.logging.Logger.getLogger(OfflineResolver.class.getName());
   ...
   public XMLSignatureInput engineResolve(Attr uri, String BaseURI)
      ...
      try {
         ...
         if (OfflineResolver._uriMap.containsKey(URI)) {
            ...
            log.log(java.util.logging.Level.FINE, "Mapped " + URI + " to " + newURI);

            InputStream is = new FileInputStream(newURI);

            log.log(java.util.logging.Level.FINE, "Available bytes = " + is.available());
   ...
   public boolean engineCanResolve(Attr uri, String BaseURI) {
      ...
      try {
         ...
         if (uriNew.getScheme().equals("http")) {
            log.log(java.util.logging.Level.FINE, "I state that I can resolve " + uriNew.toString());

            return true;
         }

         log.log(java.util.logging.Level.FINE, "I state that I can't resolve " + uriNew.toString());
   ...
   static {
      ...
      OfflineResolver.register("http://www.nue.et-inf.uni-siegen.de/index.html",
                               "data/com/sun/org/apache/xml/internal/security/temp/nuehomepage",
                               "text/html");
      OfflineResolver.register(
         "http://www.nue.et-inf.uni-siegen.de/~geuer-pollmann/id2.xml",
         "data/com/sun/org/apache/xml/internal/security/temp/id2.xml", "text/xml");
      OfflineResolver.register(
