 ...
 *
 */
package com.sun.org.apache.xml.internal.security.test.encryption;
...
public class BaltimoreEncTest extends TestCase {
    ...
    static java.util.logging.Logger log = 
        java.util.logging.Logger.getLogger(BaltimoreEncTest.class.getName());
	...
	protected void setUp() throws Exception {
		...
		KeyResolver.register("com.sun.org.apache.xml.internal.security.test.encryption.BobKeyResolver");

		// Check what algorithms are available

		haveISOPadding = false;
		String algorithmId = 
			JCEMapper.translateURItoJCEID(com.sun.org.apache.xml.internal.security.utils.EncryptionConstants.ALGO_ID_BLOCKCIPHER_AES128);
		...
		haveKeyWraps = (JCEMapper.translateURItoJCEID(com.sun.org.apache.xml.internal.security.utils.EncryptionConstants.ALGO_ID_KEYWRAP_AES128) != null);
	}
	...
	private void checkDecryptedDoc(Document d, boolean doNodeCheck) throws Exception {
		...
		log.log(java.util.logging.Level.FINE, "Retrieved Credit Card : " + cc);
	...
	public void test_five_content_3des_cbc() throws Exception {
		...
		if (haveISOPadding) {
			...
			log.log(java.util.logging.Level.WARNING, "Skipping test test_five_content_3des_cbs as necessary crypto algorithms are not available");
		}
    }
	...
	public void test_five_content_aes256_cbc() throws Exception {
		...
		if (haveISOPadding) {
			...
			log.log(java.util.logging.Level.WARNING, "Skipping test test_five_content_aes256_cbc as necessary crypto algorithms are not available");
		}
    }
	...
	public void test_five_content_aes128_cbc_kw_aes192() throws Exception {
		...
		if (haveISOPadding && haveKeyWraps) {
			...
			log.log(java.util.logging.Level.WARNING, "Skipping test test_five_content_aes128_cbc_kw_aes192 as necessary crypto algorithms are not available");
		}
    }
	...
	public void test_five_content_3des_cbc_kw_aes128() throws Exception {
		...
		if (haveISOPadding && haveKeyWraps) {
			...
			log.log(java.util.logging.Level.WARNING, "Skipping test test_five_content_3des_cbc_kw_aes128 as necessary crypto algorithms are not available");
		}
	...
	public void test_five_content_aes128_cbc_rsa_15() throws Exception {
		...
		if (haveISOPadding) {
			...
			log.log(java.util.logging.Level.WARNING, "Skipping test test_five_content_aes128_cbc_rsa_15 as necessary crypto algorithms are not available");
		}
    }
	...
	public void test_five_element_aes192_cbc_ref() throws Exception {
		...
		if (haveISOPadding) {
			...
			log.log(java.util.logging.Level.WARNING, "Skipping test test_five_element_aes192_cbc_ref as necessary crypto algorithms are not available");
		}
    }
	...
	public void test_five_data_aes128_cbc() throws Exception {
		...
		if (haveISOPadding) {
			...
			log.log(java.util.logging.Level.WARNING, "Skipping test test_five_data_aes128_cbc as necessary crypto algorithms are not available");
		}
    }
	...
	public void test_five_data_aes256_cbc_3des() throws Exception {
		...
		if (haveISOPadding && haveKeyWraps) {
			...
			log.log(java.util.logging.Level.WARNING, "Skipping test test_five_data_aes256_cbc_3des as necessary crypto algorithms are not available");
		}
    }
	...
	public void test_five_data_aes192_cbc_aes256() throws Exception {
		...
		if (haveISOPadding && haveKeyWraps) {
			...
			log.log(java.util.logging.Level.WARNING, "Skipping test test_five_data_aes192_cbc_aes256 as necessary crypto algorithms are not available");
		}
    }
	...
	public void test_five_data_3des_cbc_rsa_oaep() throws Exception {
		...
		if (haveISOPadding) {
			...
			log.log(java.util.logging.Level.WARNING, "Skipping test test_five_data_3des_cbc_rsa_oaep as necessary crypto algorithms are not available");
		}
    }
