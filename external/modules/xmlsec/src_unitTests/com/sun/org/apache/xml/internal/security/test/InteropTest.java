...
public class InteropTest extends TestCase {
   ...
   /** {@link java.util.logging} logging facility */
    static java.util.logging.Logger log = 
        java.util.logging.Logger.getLogger(InteropTest.class.getName());
   ...
   public static Test suite() {
      ...
      suite.addTest(com.sun.org.apache.xml.internal.security.test.interop.BaltimoreTest.suite());
      suite.addTest(com.sun.org.apache.xml.internal.security.test.interop.IAIKTest.suite());
      suite.addTest(com.sun.org.apache.xml.internal.security.test.interop.RSASecurityTest.suite());
      suite.addTest(com.sun.org.apache.xml.internal.security.test.c14n.implementations.ExclusiveC14NInterop.suite());

      {
         ...
         if (f.exists()) {
            suite.addTest(com.sun.org.apache.xml.internal.security.test.interop.IBMTest.suite());
         }
      }
