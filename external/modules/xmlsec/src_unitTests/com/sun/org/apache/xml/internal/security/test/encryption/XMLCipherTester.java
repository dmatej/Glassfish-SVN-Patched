...
public class XMLCipherTester extends TestCase {
    ...
    static java.util.logging.Logger log = 
        java.util.logging.Logger.getLogger(XMLCipherTester.class.getName());
	...
	public void testAES128ElementAES192KWCipherUsingKEK() throws Exception {
        ...
        if (haveISOPadding && haveKeyWraps) {
			...
			log.log(java.util.logging.Level.WARNING, "Test testAES128ElementAES192KWCipherUsingKEK skipped as necessary algorithms not available");
		}
    }
	...
	public void testAES128ElementRSAKWCipherUsingKEK() throws Exception {
        ...
        if (haveISOPadding) {
            ...
            ed = cipher.doFinal(d, e);
            log.log(java.util.logging.Level.FINE, "Encrypted document");
            log.log(java.util.logging.Level.FINE, toString(ed));
            ...
            target = toString(dd);
            log.log(java.util.logging.Level.FINE, "Output document");
            log.log(java.util.logging.Level.FINE, target);

			Assert.assertEquals(source, target);
		}
		else {
			log.log(java.util.logging.Level.WARNING, "Test testAES128ElementRSAKWCipherUsingKEK skipped as necessary algorithms not available");
		}
    }
	...
	public void testAES192ElementAES256KWCipher() throws Exception {
        ...
        if (haveISOPadding && haveKeyWraps) {
			...
			log.log(java.util.logging.Level.WARNING, "Test testAES192ElementAES256KWCipher skipped as necessary algorithms not available");
		}
    }
    ...
    public void testTrippleDesElementCipher() throws Exception {
        ...
        if (haveISOPadding) {
			...
			log.log(java.util.logging.Level.WARNING, "Test testTrippleDesElementCipher skipped as necessary algorithms not available");
		}
    }
    ...
    public void testAes128ElementCipher() throws Exception {
        ...
        if (haveISOPadding) {
			...
			log.log(java.util.logging.Level.WARNING, "Test testAes128ElementCipher skipped as necessary algorithms not available");
		}
    }
    ...
    public void testAes192ElementCipher() throws Exception {
        ...
        if (haveISOPadding) {
			...
			log.log(java.util.logging.Level.WARNING, "Test testAes192ElementCipher skipped as necessary algorithms not available");
		}
    }
    ...
    public void testAes265ElementCipher() throws Exception {
        ...
        if (haveISOPadding) {
			...
			log.log(java.util.logging.Level.WARNING, "Test testAes265ElementCipher skipped as necessary algorithms not available");
		}
    }
    ...
    public void testTrippleDesDocumentCipher() throws Exception {
        ...
        if (haveISOPadding) {
			...
			log.log(java.util.logging.Level.WARNING, "Test testTrippleDesDocumentCipher skipped as necessary algorithms not available");
		}
    }
	...
	public void testSameDocumentCipherReference() throws Exception {
        ...
        if (haveISOPadding) {
			...
			com.sun.org.apache.xml.internal.security.encryption.Transforms xencTransforms =
			...
			log.log(java.util.logging.Level.WARNING, "Test testSameDocumentCipherReference skipped as necessary algorithms not available");
		}
	...
	String filename = 
	    "data/com/sun/org/apache/xml/internal/security/encryption/encryptedKey.xml";
