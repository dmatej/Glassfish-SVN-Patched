...
public class InvalidKeyTest extends TestCase {
	...
	FileInputStream input = new FileInputStream(BASEDIR + SEP + 
	    "data/com/sun/org/apache/xml/internal/security/samples/input/truststore.jks");
    ...
    public void validate(PublicKey pk) throws Exception {
	    ...
	    "data/com/sun/org/apache/xml/internal/security/samples/input/test-assertion.xml");
