...
public class IBMTest extends InteropTest {
   ...
   /** {@link java.util.logging} logging facility */
    static java.util.logging.Logger log = 
        java.util.logging.Logger.getLogger(IBMTest.class.getName());
   ...
   public void test_enveloping_dsa_soaped_broken() throws Exception {
      ...
      if (verify) {
         log.log(java.util.logging.Level.SEVERE, "Verification failed for " + filename + ", had to be broken but was successful");
      }
