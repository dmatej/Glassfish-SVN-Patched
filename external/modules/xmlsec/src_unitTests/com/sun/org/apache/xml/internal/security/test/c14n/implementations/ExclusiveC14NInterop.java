...
import com.sun.org.apache.xml.internal.security.test.interop.InteropTest;
...
public class ExclusiveC14NInterop extends InteropTest {
   ...
   /** {@link java.util.logging} logging facility */
    static java.util.logging.Logger log = 
        java.util.logging.Logger.getLogger(ExclusiveC14NInterop.class.getName());
   ...
   public String t(String directory, String file) throws Exception
   {
      ...
      log.log(java.util.logging.Level.FINE, "   signature.checkSignatureValue finished: " + verify);
      ...
      if (true) {
         ...
         for (int i = 0; i < signature.getSignedInfo().getLength(); i++) {
            ...
            if (refVerify) {
               ...
               log.log(java.util.logging.Level.FINE, "Reference " + i + " failed: " + algo);
            }
         }
