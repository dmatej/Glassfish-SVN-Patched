...
/**
 * Test providing the spatial operator and params directly.
 * 
 * These tests pass an expression for the first geometry and bin in a JGeometry
 * as a STRUCT for the second one. SQL samples from
 * C:\oracle\db\10.2\md\demo\examples\eginsert.sql Note: Table re-named from
 * TEST81 to SIMPLE_SPATIAL
 * 
 * @author dclarke
 */
public class Query_SpatialExpOp_ExpGeom_Tests extends SpatialTestCase {
    ...
    public void testSDORelateRectangle() throws Exception {
        ...
        params.setQueryType(QueryType.WINDOW);
        Expression relateExp = SpatialExpressionFactory.relate(eb.get("geometry"), rectangle, params);
    ...
    public void testSDORelateCircle() throws Exception {
        ...
        params.setMask(Mask.ANYINTERACT);
        params.setQueryType(QueryType.WINDOW);
        Expression relateExp = SpatialExpressionFactory.relate(eb.get("geometry"), circle, params);
    ...
    public void testSDORelateArbitraryLine() throws Exception {
        ...
        params.setMask(Mask.ANYINTERACT);
        params.setQueryType(QueryType.WINDOW);
        Expression relateExp = SpatialExpressionFactory.relate(eb.get("geometry"), line, params);
    ...
    public void testSDOFilterRectangle() throws Exception {
        ...
        SpatialParameters params = new SpatialParameters();
        params.setQueryType(QueryType.WINDOW);
        Expression filterExp = SpatialExpressionFactory.filter(eb.get("geometry"), rectangle, params);

        raq.setSelectionCriteria(filterExp);
        raq.addAscendingOrdering("id");
    ...
    public void testSDOFilterRectangleNullParams() throws Exception {
        ...
        Expression filterExp = SpatialExpressionFactory.filter(eb.get("geometry"), rectangle, null);
    ...
    public void testSDOFilterCircle() throws Exception {
        ...
        SpatialParameters params = new SpatialParameters();
        params.setQueryType(QueryType.WINDOW);
        Expression filterExp = SpatialExpressionFactory.filter(eb.get("geometry"), circle, params);
    ...
    public void testSDOFilterArbitraryLine() throws Exception {
        ...
        SpatialParameters params = new SpatialParameters();
        params.setQueryType(QueryType.WINDOW);
        Expression filterExp = SpatialExpressionFactory.filter(eb.get("geometry"), line, params);
    ...
    public void testSDOWithinDistanceRectangle() throws Exception {
        ...
        SpatialParameters params = new SpatialParameters();
        params.setDistance(10);
        Expression wdExp = SpatialExpressionFactory.withinDistance(eb.get("geometry"), rectangle, params);

        raq.setSelectionCriteria(wdExp);
        raq.addAscendingOrdering("id");
    ...
    public void testSDOWithinDistanceCircle() throws Exception {
        ...
        SpatialParameters params = new SpatialParameters();
        params.setDistance(10);
        Expression wdExp = SpatialExpressionFactory.withinDistance(eb.get("geometry"), circle, params);
    ...
    public void testSDOWithinDistanceArbitraryLine() throws Exception {
        ...
        SpatialParameters params = new SpatialParameters();
        params.setDistance(10);
        Expression wdExp = SpatialExpressionFactory.withinDistance(eb.get("geometry"), line, params);
    ...
    public void testSDOWithinDistanceNullParamsMatchingCircle1004() throws Exception {
        ...
        Expression wdExp = SpatialExpressionFactory.withinDistance(eb.get("geometry"), circle, null);
