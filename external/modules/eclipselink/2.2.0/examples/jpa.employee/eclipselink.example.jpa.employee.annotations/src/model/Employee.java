...
public class Employee implements Serializable {
    ...
    @ElementCollection
    @CollectionTable(name = "PHONE", joinColumns = @JoinColumn(name = "EMP_ID"))
    @AttributeOverrides({ @AttributeOverride(name = "type", column = @Column(name = "TYPE")), @AttributeOverride(name = "areaCode", column = @Column(name = "AREA_CODE")), @AttributeOverride(name = "number", column = @Column(name = "P_NUMBER")) })
