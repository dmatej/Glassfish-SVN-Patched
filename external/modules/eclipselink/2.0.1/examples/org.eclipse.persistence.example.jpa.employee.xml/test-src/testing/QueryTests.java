...
public class QueryTests extends EclipseLinkJPATest {
    ...
    public void readAllEmployees_JPQL() {
        ...
        Sample.population.assertSame(emps);
    }

    @Test
    public void joinFetchJPQL() {
        List<Employee> emps = getExamples().joinFetchJPQL(getEntityManager());
        assertNotNull(emps);
    }

    @Test
    public void joinFetchHint() {
        List<Employee> emps = getExamples().joinFetchHint(getEntityManager());
        assertNotNull(emps);
    }
