 ...
 */
public class Query_SpatialOp_ExpExp_Tests extends SpatialTestCase {
    ...
    public void testSDORelateRectangle() throws Exception {
        ...
        populateTestGeometry(JGeometry.createLinearPolygon(new double[] { 1, 1, 1, 20, 10, 20, 20, 1, 1, 1 }, 2, 0), em);
        ...
        Expression geom2 = eb2.get("geometry");

        SpatialParameters params = new SpatialParameters();
        params.setMask(Mask.ANYINTERACT);
        params.setQueryType(QueryType.WINDOW);
        Expression relateExp = SpatialExpressionFactory.relate(geom1, geom2, params);

        raq.setSelectionCriteria(relateExp.and(eb.get("id").notEqual(6666).and(eb2.get("id").equal(6666))));
    ...
    public void testSDORelateArbitraryLine() throws Exception {
        ...
        populateTestGeometry(JGeometry.createLinearLineString(new double[] { 10, 10, 20, 20, 30, 30, 45, 45 }, 2, 0), em);
    ...
    public void testSDOFilterRectangle() throws Exception {
        ...
        Expression filterExp = SpatialExpressionFactory.filter(geom1, geom2, params);

        raq.setSelectionCriteria(filterExp.and(eb.get("id").notEqual(6666).and(eb2.get("id").equal(6666))));
        raq.addAscendingOrdering("id");
    ...
    public void testSDOFilterRectangleNullParams() throws Exception {
        ...
        Expression filterExp = SpatialExpressionFactory.filter(geom1, geom2, null);
    ...
    public void testSDOWithinDistanceRectangle() throws Exception {
        ...
        Expression wdExp = SpatialExpressionFactory.withinDistance(geom1, geom2, params);

        raq.setSelectionCriteria(wdExp.and(eb.get("id").notEqual(6666).and(eb2.get("id").equal(6666))));
        raq.addAscendingOrdering("id");
    ...
    public void testSDOWithinDistanceNullParamsMatchingCircle1004() throws Exception {
        ...
        Expression wdExp = SpatialExpressionFactory.withinDistance(geom1, geom2, null);
