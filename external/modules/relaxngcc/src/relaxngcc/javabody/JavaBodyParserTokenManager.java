/* Generated By:JavaCC: Do not edit this line. JavaBodyParserTokenManager.java */
package relaxngcc.javabody;
import java.util.Set;
import java.util.TreeSet;

public class JavaBodyParserTokenManager implements JavaBodyParserConstants
{
...
public JavaBodyParserTokenManager(SimpleCharStream stream)
{
   if (SimpleCharStream.staticFlag)
      throw new Error("ERROR: Cannot use a static CharStream class with a non-static lexical analyzer.");
   input_stream = stream;
}
public JavaBodyParserTokenManager(SimpleCharStream stream, int lexState)
{
   this(stream);
   SwitchTo(lexState);
}
