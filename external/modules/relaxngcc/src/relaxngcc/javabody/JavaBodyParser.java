/* Generated By:JavaCC: Do not edit this line. JavaBodyParser.java */
 ...
 */
public class JavaBodyParser implements JavaBodyParserConstants {
// modified main Andrea Gini 24/02/2002
// modified main. DW, 7/99
    public static void main (String [] args) {
        JavaBodyParser parser;
        ...
        if (args.length == 0)
        {
            ...
            parser = new JavaBodyParser(System.in);
        } else if (args.length == 1)
        {
            ...
            try
            {
                ...
                parser = new JavaBodyParser(new java.io.FileInputStream(filename));
        ...
        public final Set fields = new TreeSet();
...
//==================================================================
//
// added for JavaBodyParser
//
//==================================================================
  final public void JavaBody() throws ParseException {
    label_42:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case ABSTRACT:
  ...
  public JavaBodyParser(java.io.InputStream stream) {
    ...
    token_source = new JavaBodyParserTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
