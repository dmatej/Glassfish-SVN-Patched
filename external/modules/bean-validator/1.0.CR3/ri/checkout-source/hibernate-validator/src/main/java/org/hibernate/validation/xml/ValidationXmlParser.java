// $Id: ValidationXmlParser.java 16798 2009-06-16 16:16:48Z hardy.ferentschik $
/*
	...
	private InputStream getInputStreamForPath(String path) {
		...
		InputStream inputStream = null;
                ...
                try {
                    ...
                    String message = "Error while trying to load " + path + " from current Thread Context ClassLoader.";
		...
		if ( inputStream == null ) {
			...
			inputStream = this.getClass().getResourceAsStream( path );
                    ...
                    String message = "Error while trying to load " + path + " from local class ClassLoader.";
                        log.error(message, ex.getMessage());
                    }
		}
		return inputStream;
